...
<template>
  <section class="slidev-layout six-cells-header" :class="layoutClass">
    ...
    <div class="cells">
      ...
      <div class="col-top-center" :class="props.class">
      ...
      <div class="col-bottom-center" :class="props.class">
...
<style>
.slidev-layout.six-cells-header {
